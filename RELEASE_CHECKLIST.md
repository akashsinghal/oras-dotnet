...
4. The tag push automatically triggers:
   - [`release-github`](.github/workflows/release-github.yml): Creates a GitHub Release with auto-generated release notes. Pre-release versions (alpha, beta, rc, preview) are automatically marked as pre-releases.
   - [`release-nuget`](.github/workflows/release-nuget.yml): Builds and publishes the NuGet package.
5. Wait for NuGet to validate the newly released package.
6. Announce the release in the community.
